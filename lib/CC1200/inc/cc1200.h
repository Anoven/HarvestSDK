...
// SmartRF Studio Settings - High Performance ETSI standard
//#include "cc1200_settings_500kbps_etsi.h"
#include "cc1200_38_4_rx_sniff.h"
struct CC1200_PACKET {
	uint8_t len;
	uint8_t dst;
	uint8_t src;
	uint8_t type;
...
//uint8_t cc1200_send_acc_packet(struct acc_data_struct *acc_data);
...
void cc1200_tx_test(void);
void cc1200_rx_test(void);
